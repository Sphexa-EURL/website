      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-14 gap-8">
          <div className="md:col-span-6 lg:col-span-5">
            <div className="flex items-center gap-2 mb-3">
              <Link href="/" className="block w-[100px] sm:w-[125px]">
                <Image
          ...
          <div className="md:col-span-3 lg:col-span-3 ">
            <h3 className="font-medium mb-4 text-sphexa">Our Services</h3>
            <nav className="flex flex-col space-y-2">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm mb-4 md:mb-0 text-muted-foreground">
            &copy; 2025 <span className="text-sphexa">{siteConfig.name}</span>{' '}
            All Rights Reserved
          </p>
